...
function ProfileUpdate(submit) {
  ...
  useEffect(() => {
    ...
    setinputField([
      { ex: profileDetails.ex1 },
      { ex: profileDetails.ex2 },
      { ex: profileDetails.ex3 },
    ]);
    setinputFieldED([
      { ed: profileDetails.ed1 },
      { ed: profileDetails.ed2 },
      { ed: profileDetails.ed3 },
    ]);
    setfini(true);
    setfidi(true);
  }, [profileDetails]);
