...
function GeneEnrollmentkeys() {
  let location = matchPath(useLocation().pathname, {
    path: [
      "/teacherdashboard/keys/genkeys/:id/:ccid",
      "/teacherdashboard/keys/viewallissuekey/:id/:ccid",
    ],
    exact: true,
    strict: false,
  });
  ...
  return (
    <div className="main_sub">
      <div className="simple_nav">
        <Link
          to={`/teacherdashboard/keys/genkeys/${location.params.id}/${location.params.ccid}`}
        >
          Generate Enrollment Keys
        </Link>
        <Link
          to={`/teacherdashboard/keys/viewallissuekey/${location.params.id}/${location.params.ccid}`}
        >
      ...
      <div className="show">
        <div className="back">
          <Link
            to={`/teacherdashboard/models/${location.params.id}/${location.params.ccid}`}
          >
            <button>
