...
export default function CreateCourse() {
  ...
  function submit() {
    ...
    Axios.post(
      `${process.env.REACT_APP_LMS_MAIN_URL}/course-api/createcourse/${id}/${usDetails.id}/`,
      form_data,
      {
  ...
  if (redirec.id) {
    return (
      <Redirect to={`/teacherdashboard/createmodels/${redirec.id}/${id}`} />
    );
  }
    ...
    <div className="subject_form">
      ...
      <div className="main_form">
        ...
        <CourseCreateForm
          ...
          handelFormValues={handelFormValues}
          hideError={hideError}
